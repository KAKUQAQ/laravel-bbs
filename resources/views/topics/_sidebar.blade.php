...
@if(count($active_users))
    <div class="card mt-4">
        <div class="card-body active-users pt-4">
            ...
            @foreach($active_users as $user)
                <a class="d-flex mt-2 text-decoration-none ms-3" href="{{ route('users.show', $user->id) }}">
                    <div class="media-left media-middle me-2 ms-1">
                        <img src="{{ $user->avatar }}" class="media-object" width="24px" height="24px" alt="{{ $user->name }}">
                    </div>
    ...
    <div class="card mt-4">
        <div class="card-body pt-2">
            ...
            @foreach($links as $link)
                <a class="d-flex mt-2 text-decoration-none ms-3" href="{{ $links->link }}">
